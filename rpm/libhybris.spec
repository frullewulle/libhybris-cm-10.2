Name:      libhybris-cm-10.2-exynos4
Version:   0.0.0
Release:   1%{?dist}
Summary:   Utilize Bionic-based HW adaptations on glibc systems (Exynos4 variant)
...
%configure \
  ...
  --enable-arch=arm \
  CFLAGS="-DEXYNOS4_ENHANCEMENTS" CXXFLAGS="-DEXYNOS4_ENHANCEMENTS"
